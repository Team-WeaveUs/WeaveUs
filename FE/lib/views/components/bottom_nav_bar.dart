    ...
    return Obx(() => BottomNavigationBar(
          ...
          items: [
            const BottomNavigationBarItem(
              icon: Icon(HugeIcons.strokeRoundedHome05, color: Colors.black),
              label: "",
            ),
            const BottomNavigationBarItem(
              icon: Icon(HugeIcons.strokeRoundedSearch02, color: Colors.black),
              label: "",
            ),
            ...
            const BottomNavigationBarItem(
              icon: Icon(HugeIcons.strokeRoundedGift, color: Colors.black),
              label: "",
            ),
            const BottomNavigationBarItem(
              icon: Icon(HugeIcons.strokeRoundedUser, color: Colors.black),
              label: "",
            ),
          ],
        ));
